        ...
        <main className='post'>
            <div className="user">
                <div className="profileimagewrapper">
                    <img src="https://images.unsplash.com/photo-1769758791765-9d4e8cc5a38d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw1fHx8ZW58MHx8fHx8" alt="" />
                </div>
            ...
            <div className="icons">
                <div className="options">
                    <div className="left">
                        <button onClick={async () => { await likehandler(post._id) }}><svg
